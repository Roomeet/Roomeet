...
const TermsConditionPage: React.FC = () => (
  <div className="about">
    ...
    <ul>
      ...
      <li>Website refers to Roomeet, accessible from https://www.Roomeet.com</li>
    ...
    <p>
      ...
      agreement that operates
      between You and the Company. These Terms and Conditions set out the rights
      and obligations of all
      users regarding the use of the Service.

      Your access to and use of the Service is conditioned on Your acceptance
      of and compliance with these Terms and Conditions. These Terms and Conditions apply
      to all visitors,
    ...
    <p>
      ...
      and any of its suppliers under any provision of this Terms and Your exclusive remedy for all
      ...
      of the above limitations may not apply. In these states, each party's liability
    ...
    <p>
      ...
      or currency of any information or content provided through the Service;
      or (iv) that the Service, its servers, the content, or e-mails sent from
      ...
      of the above exclusions and limitations may not apply to You. But in such a case
    ...
    <p>
      ...
      least 30 days' notice prior to any new terms taking effect. What constitutes a material
      change will be determined at Our sole discretion.

      By continuing to access or use Our Service after those revisions become effective, You
      agree to be bound by the revised terms. If You do not agree to the new terms, in
    ...
    <ul>
      <li>By email: Roomeet@gmail.com</li>
    </ul>
  </div>
);
